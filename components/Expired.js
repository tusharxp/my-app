...
function Expired() {
  return (
    <div className="relative flex flex-wrap items-center justify-around w-full pt-12 pb-10 md:flex-nowrap bg-gradient-to-r from-red-400 to-rose-500 xl:px-52 justify-items-center ">
      <Image
